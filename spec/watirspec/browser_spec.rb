...
describe "#html" do
  ...
  describe "#name" do
    it "returns browser name" do
      not_compliant_on :watir_classic, [:webdriver, :phantomjs], :watir_nokogiri do
      ...
      deviates_on :watir_nokogiri do
        browser.name.should == :nokogiri
      end      
    end
  end
  ...
  describe "#goto" do
    ...
    not_compliant_on :internet_explorer, [:webdriver, :safari], :watir_nokogiri do
